...
type IpSecVpnLocalEndpoint struct {
	...
	// VPN Service id.
	IpsecVpnServiceId *ResourceReference `json:"ipsec_vpn_service_id"`
	// Certificate authority (CA) identifier list to verify peer certificates.
	TrustCaIds []string `json:"trust_ca_ids,omitempty"`
	// Local identifier.
	...
	TrustCrlIds []string `json:"trust_crl_ids,omitempty"`
}
